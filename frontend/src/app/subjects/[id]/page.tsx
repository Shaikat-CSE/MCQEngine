        ...
        {!isLoading && !isError && totalPages > 1 && (
          <div className="mt-12 flex justify-between items-center bg-white border border-zinc-200/80 p-4 rounded-3xl shadow-sm select-none">
            <button
              ...
              disabled={page === 1}
              className="flex items-center gap-1.5 px-3 py-2 md:px-4 md:py-2.5 rounded-2xl border border-zinc-200/80 hover:border-zinc-300 disabled:opacity-40 disabled:hover:border-zinc-200/80 text-zinc-600 text-xs font-bold font-outfit transition-all cursor-pointer disabled:cursor-not-allowed"
            >
